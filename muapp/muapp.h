...
const Int_t kMaxPrimaryTracks = 10000;
const Int_t kMaxGlobalTracks = 100000;
const Int_t kMaxOtherTracks = 10000;
...
const Int_t kMaxCovGlobTrack = 100000;
const Int_t kMaxCovPrimTrack = 10000;
...
const Int_t kMaxBTofHit = 10000;
const Int_t kMaxBTofRawHit = 10000;
const Int_t kMaxBTofHeader = 1;
const Int_t kMaxMTDHit = 10000;
const Int_t kMaxMTDRawHit = 10000;
...
public :
	...
	muapp(TTree *tree=0, Int_t mrun=0, Int_t myear=0, Int_t mday=0);
	virtual ~muapp();
	virtual Int_t    Cut(Long64_t entry);
	virtual Int_t    GetEntry(Long64_t entry);
	virtual Long64_t LoadTree(Long64_t entry);
	virtual void     Init(TTree *tree);
	virtual void     Loop(Int_t kToDo);
	virtual Bool_t   Notify();
	virtual void     Show(Long64_t entry = -1);
	virtual void     ReadQTcorr(Int_t icrate);
	...
	TGraph* qtcorr_bbq[16][2];
	TGraph* qtcorr_mxq[16][2];
...
//    TH1D *mRefMult;            //!
	...
	Int_t    nevtseen; 
	ULong64_t   trigindex;
	UInt_t   itime,itimemin;
	Int_t    istream;
	Int_t 	 runid,evtid,iday,iyear;
	Int_t    grefmult;
	Int_t    nvert;
	Int_t    nprimary;
	Int_t    nglobal;
	...
	Float_t  fill[2];
	Float_t  field;
	Float_t  zdcrate[2],zdccoinrate;
	Float_t  bbcrate[2],bbccoinrate;
	Float_t  bbcbg[2];
	//
	//---- TRG data
	Float_t	 vpd_adc[38];
