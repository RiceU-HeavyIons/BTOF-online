...
FILES=/star/data09/reco/pp200_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
...
FILES=/star/data10/reco/pp200_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
DIROUT=/star/institutions/rice/llope/pdst/run12/$day/pDst_
for f in $FILES
do
  fin=`echo $f`
...
FILES=/star/data12/reco/pp200_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
DIROUT=/star/institutions/rice/llope/pdst/run12/$day/pDst_
for f in $FILES
do
  fin=`echo $f`
