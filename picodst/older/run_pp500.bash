...
#FILES=/star/data09/reco/cuAu_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
FILES=/star/data09/reco/pp500_production_2013/ReversedFullField/dev/2013/$day/*/st_physics_1*.MuDst.root
...
#FILES=/star/data10/reco/cuAu_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
FILES=/star/data10/reco/pp500_production_2013/ReversedFullField/dev/2013/$day/*/st_physics_1*.MuDst.root
DIROUT=/star/institutions/rice/llope/pdst/run13/$day/pDst_
for f in $FILES
do
  fin=`echo $f`
...
#FILES=/star/data12/reco/cuAu_production_2012/ReversedFullField/dev/2012/$day/*/st_physics_1*.MuDst.root
FILES=/star/data12/reco/pp500_production_2013/ReversedFullField/dev/2013/$day/*/st_physics_1*.MuDst.root
DIROUT=/star/institutions/rice/llope/pdst/run13/$day/pDst_
for f in $FILES
do
  fin=`echo $f`
