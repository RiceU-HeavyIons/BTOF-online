...
sprintf(type,"14113070_tof");
//sprintf(type,"14113072_tof");
...
//---- run13 pp500 mtdtest
	const char* triggernames[64] = {
		...
		"",			// 400000000	
		"",			// 800000000	
		"BHT3*L2BW",				// 1000000000	
		"EHT1*L2BW",				// 2000000000	
		"JP2*L2JetHigh",			// 4000000000	
		"BHT2*BJP1*L2Bgamma",		// 8000000000	
		"VPDMB",					// 10000000000	
		"BBCMB",					// 20000000000	
		"",			// 40000000000	
		"",			// 80000000000	
...
cout<<buf<<endl;
	...
	TF1 *g1	= new TF1("g1","gaus",-2790,-2750);
		g1->SetLineWidth(2);
		g1->SetLineColor(2);
	TF1 *g2	= new TF1("g2","gaus",2000,2040);
		g2->SetLineWidth(2);
		g2->SetLineColor(2);
	...
	float crossingperiod	= (gpars2[1]-gpars1[1])/45.;
